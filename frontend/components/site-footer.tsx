      ...
      <div className="container-main grid gap-8 py-10 md:grid-cols-4">
        ...
        <div>
          ...
          <nav className="mt-3 flex flex-col gap-2 text-sm text-muted">
            ...
            <Link href="/checkout" className="transition hover:text-primary">Siparişlerim</Link>
          </nav>
        </div>
        <div>
          <p className="text-sm font-semibold text-ink">Yardım</p>
          <nav className="mt-3 flex flex-col gap-2 text-sm text-muted">
            <Link href="#" className="transition hover:text-primary">Sıkça Sorulan Sorular</Link>
            <Link href="#" className="transition hover:text-primary">İade & Değişim</Link>
            <Link href="#" className="transition hover:text-primary">Kargo Takibi</Link>
            <Link href="#" className="transition hover:text-primary">İletişim</Link>
          </nav>
        </div>
      </div>
      ...
      <div className="border-t border-border">
        <div className="container-main flex flex-col items-center justify-between gap-3 py-4 text-xs text-muted md:flex-row">
          ...
          <div className="flex items-center gap-4">
            <Link href="#" className="transition hover:text-primary">Gizlilik Politikası</Link>
            <Link href="#" className="transition hover:text-primary">Kullanım Koşulları</Link>
            <Link href="#" className="transition hover:text-primary">KVKK</Link>
          </div>
        </div>
      </div>
    </footer>
